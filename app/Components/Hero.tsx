    ...
    <div className="bg-[rgb(246,246,244)]">
      <div className="max-w-12xl mx-auto px-8 py-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center ">
          ...
          <div className="ml-28 lg:w-[620px]">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-sm mt-4">
              <div className="flex-1">
                <input
                  type="email"
                  placeholder="What is your work email?"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-transparent text-sm"
                />
              </div>
              <button className="px-5 py-3 bg-gradient-to-r from-lime-400 to-lime-500 text-white font-semibold rounded-lg hover:from-lime-500 hover:to-lime-600 transition-all duration-200 flex items-center justify-center whitespace-nowrap text-sm">
                Get Started ▸
              </button>
            </div>
          </div>

          <div className="relative flex flex-col items-end-safe mr-24 z-10">
            {/* Main container with proper sizing and styling */}
            <div className="bg-white rounded-2xl shadow-xl p-5 border-gray-300 border-1 w-90 h-120">

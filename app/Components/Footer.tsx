            ...
            <div className="max-w-7xl mx-auto relative ">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="space-y-3 ml-24 mt-24">
                        ...
                        <div className="text-[10px] ml-2 text-gray-400 space-y-1">
                        ...
                        <div className="flex space-x-6 pt-44">
                            ...
                            <a href="#" className="text-xs font-semibold text-gray-900">Join the Community</a>
                        </div>
                    </div>
                    ...
                    <div className="flex space-x-8 gap-12 mt-24">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-4 text-[11px] font-semibold text-black">
                                ...
                                <li><a href="#" className="text-black">Platform Status</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-4 text-[11px] font-semibold text-black">
                                ...
                                <li><a href="#" className="text-gray-900">Refer a Friend</a></li>
                            </ul>
                        </div>
                ...
                <hr className="border-gray-300 border-[1px] mt-8 max-w-5xl mx-auto" />

...
export default function Accelerator() {
    return (
        <div className="max-w-5xl mx-auto px-8 mb-24 py-20 ">
            <div className="grid lg:grid-cols-2 lg:w-[800px]">
                <div className="lg:w-70">
                    <h1 className="text-lg lg:text-2xl font-semibold leading-tight bg-gradient-to-r from-[rgb(128,198,183)] to-[rgb(123,236,211)] bg-clip-text text-transparent">
                        Why enroll in our Agent Accelerator Program?
                    </h1>
                </div>

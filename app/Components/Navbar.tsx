...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-[rgb(246,246,244)] border-b border-gray-100 px-6 py-4 top-0 z-40">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="#" className="text-gray-700 hover:text-gray-900 font-semibold text-xs transition-colors duration-200">
            Platform
          </a>
          <a href="#" className="text-gray-700 hover:text-gray-900 font-semibold text-xs transition-colors duration-200">
            Agent Accelerator
          ...
          <div className="relative" ref={resourcesRef}>
            <button
              ...
              className="flex items-center text-gray-700 hover:text-gray-900 font-semibold text-xs transition-colors duration-200"
            >
              Resources
              <svg 
                className={`ml-1 w-4 h-4 transition-transform duration-200 ${resourcesOpen ? 'rotate-180' : ''}`}
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
            ...
            {resourcesOpen && (
              <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50 animate-in fade-in-0 slide-in-from-top-2 duration-200">
                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">Documentation</a>
                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">Tutorials</a>
                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">API Reference</a>
              </div>
            )}
          </div>
          ...
          <div className="relative" ref={companyRef}>
            ...
            >
              Company
              <svg 
                className={`ml-1 w-4 h-4 transition-transform duration-200 ${companyOpen ? 'rotate-180' : ''}`}
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
            ...
            {companyOpen && (
              <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50 animate-in fade-in-0 slide-in-from-top-2 duration-200">
                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">About</a>
                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">Careers</a>
                <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">Contact</a>
              </div>
            )}
          </div>
        ...
        <div className="flex items-center space-x-4">
          <button className="px-4 py-2 text-gray-700 font-medium border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 hover:border-gray-400">
            Sign In
          </button>
          <button className="px-4 py-2 bg-gradient-to-r from-lime-400 to-lime-500 text-white font-medium rounded-lg hover:from-lime-500 hover:to-lime-600 transition-all duration-200 flex items-center shadow-sm hover:shadow-md">
            Book a Demo

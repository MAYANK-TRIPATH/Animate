...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="w-full bg-[rgb(246,246,244)] border-b border-gray-100 px-4 sm:px-6 py-4 top-0 z-40 relative">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center ml-4 sm:ml-8 lg:ml-24 mt-2 lg:mt-4">
          ...
          <div className="hidden lg:flex items-center space-x-8 lg:pt-6 mr-8 lg:mr-24">
            <a href="#" className="text-gray-700 hover:text-gray-900 font-semibold text-[10px] transition-colors duration-200">
              Platform
            </a>
            <a href="#" className="text-gray-700 hover:text-gray-900 font-semibold text-[10px] transition-colors duration-200">
              Agent Accelerator
            ...
            <div className="relative" ref={resourcesRef}>
              <button
                ...
                className="flex items-center text-gray-700 hover:text-gray-900 font-semibold text-[10px] transition-colors duration-200"
              >
                Resources
                <svg 
          ...
          <div className="hidden sm:flex items-center space-x-2 lg:space-x-4 lg:mr-24 lg:pt-6">
